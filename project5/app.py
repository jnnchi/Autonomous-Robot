...
def rest_fwd():
    ...
    f_dist = request.args.get('f', default=1, type=int)
...
def rest_bwd():
    b_dist = request.args.get('b', default=1, type=int)
...
def rest_left():
    l_deg = request.args.get('l', default=1, type=int)
    rob.turn_left(l_deg)
...
def rest_right():
    r_deg = request.args.get('r', default=1, type=int)
